<html>
<head>
	<title>fukken admin stuf</title>
</head>
<body>
	<p>add images and audio by ftp. instructions to come.</p>
	<ul>
		<li><h3>warning: if you click on either of these two they will delete and reset content for either derives or derive sets.</h3></li>
		<ul>
